            ...
            <section className="p-8 mt-8">
                <div className="flex justify-between">
                    <div>
                        ...
                        <p className="text-grey font-medium mt-2"> Attribut les bons rôles au sein de l’équipe </p>
                    </div>
                    <div>
                        <img className="-mt-8 w-80" src="/assets/illustration/illu-effectif.png" alt="" />
                    </div>
                </div>
                ...
                <div className="bg-shadow bg-purple-100 p-8 rounded-2xl">
                    <div className="flex justify-between items-center">
                        ...
                        <img className="w-10" src="/assets/illustration/icon-group.png" alt="" />
                    </div>
